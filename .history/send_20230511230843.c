...
void print_msg(int send_fd, char* buf, char* err_message)
{
    int r_size = -1;
...
void send_mail(const char* receiver, const char* subject, const char* msg, const char* att_path)
{
    ...
    const char* user = "my_usernum"; // TODO: Specify the user
    const char* pass = "my_password"; // TODO: Specify the password
    const char* from = "my_address@qq.com"; // TODO: Specify the mail address of the sender
    ...
    print_msg(s_fd,buf,"recv password");
